...
- (NSData *)toDnsQuestionData:(NSError *__autoreleasing  _Nullable *)error {
    ...
    if (self.recordType != QNDnsRecordTypeA &&
        self.recordType != QNDnsRecordTypeNS &&
        self.recordType != QNDnsRecordTypeCNAME &&
        self.recordType != QNDnsRecordTypeSOA &&
        self.recordType != QNDnsRecordTypeTXT &&
        self.recordType != QNDnsRecordTypeAAAA) {
